...
namespace SPTEditorUI.IO
{
    ...
    public class BinaryReaderY : BinaryReader
    {
        ...
        #region Constructors
        public BinaryReaderY(Stream input, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, Encoding.Unicode)
        {
            ByteOrder = byteOrder;
        ...
        public BinaryReaderY(Stream input, Encoding encoding, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, encoding)
        {
            ByteOrder = byteOrder;
            _blockSize = blockSize;
            this.BitOrder = BitOrder;
        ...
        public BinaryReaderY(Stream input, Encoding encoding, bool leaveOpen, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, encoding, leaveOpen)
        {
            ByteOrder = byteOrder;
            _blockSize = blockSize;
            this.BitOrder = BitOrder;
        ...
        public BinaryReaderY(Stream input, bool leaveOpen, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, Encoding.Unicode, leaveOpen)
        {
            ByteOrder = byteOrder;
            _blockSize = blockSize;
            this.BitOrder = BitOrder;
