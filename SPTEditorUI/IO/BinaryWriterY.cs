...
namespace SPTEditorUI.IO
{
    public class BinaryWriterY : BinaryWriter
    {
        ...
        #region Constructors
        public BinaryWriterY(Stream input, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, Encoding.Unicode)
        {
            ByteOrder = byteOrder;
        ...
        public BinaryWriterY(Stream input, Encoding encoding, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, encoding)
        {
            ByteOrder = byteOrder;
            _blockSize = blockSize;
            this.BitOrder = BitOrder;
        ...
        public BinaryWriterY(Stream input, Encoding encoding, bool leaveOpen, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, encoding, leaveOpen)
        {
            ByteOrder = byteOrder;
            _blockSize = blockSize;
            this.BitOrder = BitOrder;
        ...
        public BinaryWriterY(Stream input, bool leaveOpen, ByteOrder byteOrder = ByteOrder.LittleEndian, int blockSize = 32, BitOrder BitOrder = BitOrder.MSBFirst) : base(input, Encoding.Unicode, leaveOpen)
        {
            ByteOrder = byteOrder;
            _blockSize = blockSize;
            this.BitOrder = BitOrder;
